    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/api/users/**", "/css/**", "/js/**", "/images/**").permitAll()
                        .requestMatchers("/talents/register", "/talents/my").authenticated()
                        .anyRequest().permitAll()
                )
                .formLogin(form -> form
                        .loginPage("/login")
                        .defaultSuccessUrl("/talents/register", true)
                        .permitAll()
                )
